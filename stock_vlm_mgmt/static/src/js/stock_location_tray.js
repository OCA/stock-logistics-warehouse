...
odoo.define("stock_location_tray.tray", function (require) {
    ...
    var LocationTrayMatrixField = DebouncedField.extend({
        ...
        init: function (parent, name, record, options) {
            ...
            this.liveCellEdit =
                !this.clickAction &&
                this.nodeOptions.live_cell_edit &&
        ...
        start: function () {
            ...
            return this._super.apply(this, arguments).then(() => {
                if (this.clickAction || this.liveCellEdit) {
        ...
        _onClick: function (ev) {
            ...
            // Allow to edit the position on the tray
            if (this.liveCellEdit) {
                this.value.selected = [coordX, coordY];
            ...
            // Perform an action over the cell when it has contents
            if (this.clickAction && this.value.cells[coordY][coordX] === 1) {
                ev.stopPropagation();
                this.trigger_up("button_clicked", {
                    attrs: {
                        type: "object",
                        name: this.clickAction,
                        args: `[${coordX}, ${coordY}]`,
                    },
                    record: this.record,
                });
        ...
        _resizeDebounce: function () {
            ...
            this._resizePromise = setTimeout(() => {
                this._render();
            }, 20);
        },
