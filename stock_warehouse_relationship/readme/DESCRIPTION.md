This module add relationship on various stock models to warehouses
(stock.warehouse).

This is technical modules to be use as base for other modules such as:

- **stock_multi_warehouse_security**: Add ir rules to restrict user
  access to a list of warehouses
