...
.. 
   ...
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !! source digest: sha256:51d3dd405bbd934d101c90d96ae3ac2eb74fc89102bfe433cc7b2ed8f3a51cfe
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
2. In the Operations section, uncheck "Allow Immediate Transfer from
   Move Location Wizard".

This setting is per company. When it is unchecked, the "IMMEDIATE
...
- If "PLANNED TRANSFER" is used - the picking won't be validated
  automatically
- "IMMEDIATE TRANSFER" is not available if it is disallowed in the
