...
class TestStockMoveLocationDestConstraintTag(SavepointCase):
    ...
    def setUpClass(cls):
        ...
        cls.product_sulfuric_acid = cls.env.ref(
            'stock_move_location_dest_constraint_tag.product_product_sulfuric_acid'
        )
        cls.product_ammonium = cls.env.ref(
            'stock_move_location_dest_constraint_tag.product_product_ammonium_nitrate'
        )
        ...
        cls.location_freezer = cls.env.ref(
            'stock_move_location_dest_constraint_tag.location_freezer_dangerous'
        )
    ...
    def test_manual_move_category_restricted(self):
        ...
        move = self._create_and_assign_move(
            self.product_sulfuric_acid, self.location_stock, self.location_acids
        )
        self.assertEqual(move.state, 'assigned')
        self.assertEqual(move.move_line_ids.location_dest_id, self.location_acids)
        ...
        self.assertEqual(move.state, 'assigned')
        self.assertEqual(move.move_line_ids.location_dest_id,
                         self.location_acids)
    ...
    def test_manual_move_product_restricted(self):
        ...
        # Location freezer is cold + dangerous
        move = self._create_and_assign_move(
            self.product_ammonium, self.location_stock,
            self.location_freezer
        )
        self.assertEqual(move.state, 'assigned')
        self.assertEqual(move.move_line_ids.location_dest_id,
