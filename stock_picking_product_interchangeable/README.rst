...
- "If any available". Interchangeable products will be added if there is
  at least a single one available.
...
- Create a new quotation with some interchangeable product(s) in it |New
  quotation|
