...
You must enable product.group_purchase_pricelist or product.group_sale_pricelist to use this feature.
This is required to view the stock location properties on the partner view.
