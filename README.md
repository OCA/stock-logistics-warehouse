...
[stock_inventory](stock_inventory/) | 15.0.1.1.0 |  | Allows to do an easier follow up of the Inventory Adjustments
...
[stock_move_location](stock_move_location/) | 15.0.1.3.2 |  | This module allows to move all stock in a stock location to an other one.
...
[stock_secondary_unit](stock_secondary_unit/) | 15.0.2.0.0 |  | Get product quantities in a secondary unit
