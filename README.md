...
[stock_helper](stock_helper/) | 14.0.1.2.0 |  | Add methods shared between various stock modules
...
[stock_location_orderpoint](stock_location_orderpoint/) | 14.0.1.0.2 | [![mt-software-de](https://github.com/mt-software-de.png?size=30px)](https://github.com/mt-software-de) | Declare orderpoint on a location allowing to replenish any product with the same criteria.
...
[stock_picking_volume](stock_picking_volume/) | 14.0.1.0.1 | [![lmignon](https://github.com/lmignon.png?size=30px)](https://github.com/lmignon) | Compute volume information on stock moves and pickings
...
[stock_request](stock_request/) | 14.0.1.6.2 |  | Internal request for stock
