...
[stock_picking_completion_info](stock_picking_completion_info/) | 10.0.1.1.0 |  | Display on current document completion information according to next operations
