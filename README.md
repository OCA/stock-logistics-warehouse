...
[stock_move_location](stock_move_location/) | 14.0.1.4.0 |  | This module allows to move all stock in a stock location to an other one.
...
[stock_quant_view_reservation](stock_quant_view_reservation/) | 14.0.1.0.0 |  | Allows to see details of reservations on a quant
[stock_request](stock_request/) | 14.0.1.2.0 |  | Internal request for stock
...
[stock_request_kanban](stock_request_kanban/) | 14.0.1.1.0 |  | Adds a stock request order, and takes stock requests as lines
[stock_request_mrp](stock_request_mrp/) | 14.0.1.0.0 |  | Manufacturing request for stock
