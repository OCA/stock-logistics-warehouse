...
[procurement_auto_create_group](procurement_auto_create_group/) | 14.0.1.1.0 |  | Allows to configure the system to propose automatically new procurement groups during the procurement run.
...
[stock_cycle_count](stock_cycle_count/) | 14.0.1.1.1 | [![LoisRForgeFlow](https://github.com/LoisRForgeFlow.png?size=30px)](https://github.com/LoisRForgeFlow) | Adds the capability to schedule cycle counts in a warehouse through different rules defined by the user.
...
[stock_inventory_discrepancy](stock_inventory_discrepancy/) | 14.0.1.0.0 |  | Adds the capability to show the discrepancy of every line in an inventory and to block the inventory validation when the discrepancy is over a user defined threshold.
...
[stock_request](stock_request/) | 14.0.1.0.4 |  | Internal request for stock
