...
[purchase_packaging](purchase_packaging/) | 10.0.1.1.2 |  | In purchase, use package
...
[stock_helper](stock_helper/) | 10.0.1.1.1 |  | Add methods shared between various stock modules
...
[stock_packaging_calculator](stock_packaging_calculator/) | 10.0.1.0.0 |  | Compute product quantity to pick by packaging
