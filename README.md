...
[stock_available_mrp](stock_available_mrp/) | 14.0.1.0.4 |  | Consider the production potential is available to promise
...
[stock_exception](stock_exception/) | 14.0.1.0.0 |  | Custom exceptions on stock picking
...
[stock_orderpoint_manual_procurement](stock_orderpoint_manual_procurement/) | 14.0.1.0.3 |  | Allows to create procurement orders from orderpoints instead of relying only on the scheduler.
