...
class TestStockMoveActualDate(TransactionCase):
    ...
    def test_stock_move_without_actual_date_from_picking_or_scrap(self):
        ...
        self.assertEqual(scrap.move_ids.actual_date, date(2024, 9, 21))
        self.assertEqual(scrap.move_ids.account_move_ids.date, date(2024, 9, 21))
        valuation_layer = move.stock_valuation_layer_ids
        self.assertEqual(valuation_layer.actual_date, date(2024, 9, 21))
        account_move = valuation_layer.account_move_id
        account_move.button_draft()
        account_move.name = "/"
        account_move.date = "2024-11-30"
        account_move.action_post()
        self.assertEqual(valuation_layer.actual_date, date(2024, 11, 30))
