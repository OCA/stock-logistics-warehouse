...
class StockMoveLine(models.Model):
    ...
    def write(self, vals):
        ...
        if vals.get("location_dest_id") and not self.env.context.get(
            "_sync_common_dest_location"
        ):
            ...
            if related_moves:
                ...
                moves_lines_to_update.with_context(
                    _sync_common_dest_location=True
                ).write({"location_dest_id": vals.get("location_dest_id")})
        return res
