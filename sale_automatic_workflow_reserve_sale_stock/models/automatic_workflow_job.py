...
class AutomaticWorkflowJob(models.Model):
    ...
    def _make_stock_reservation(self):
        ...
        for sale in sales:
            ...
            # Check that the date_order is set at least at n days declared at
            # workflow_process. Doing this, we are sure that the
            # reservation.validity_date will be at least at today. If this wasn't like
            # that, the cron of stock_reserve will release this reservation.
