This module extends the stock.lot model to manage customer and vendor warranty dates on
lots and serial numbers.

The dates are shown and editable on every lot, whatever the tracking type of its product.
The automatic computation below only runs for serial-tracked products, since a lot can be
received or delivered on several different dates and there is no single date the whole lot
could derive its warranty from.
...
Users can always edit the warranty dates manually on the lot/serial form, with all changes
logged in the chatter for full traceability.
