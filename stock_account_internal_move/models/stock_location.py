...
class StockLocation(models.Model):
    ...
    force_accounting_entries = fields.Boolean(string="Force accounting entries?")

    @api.constrains("usage", "force_accounting_entries")
    ...
    def _check_internal_valuation_accounts_present(self):
        ...
        for loc in self:
            ...
            if not loc.valuation_in_account_id or not loc.valuation_out_account_id:
                raise ValidationError(
                    _(
