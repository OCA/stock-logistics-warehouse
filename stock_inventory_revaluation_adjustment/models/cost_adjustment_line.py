...
class CostAdjustmentLine(models.Model):
    ...
    price_outdated = fields.Boolean(compute="_compute_outdated")
    qty_outdated = fields.Boolean(compute="_compute_outdated")
    percent_difference = fields.Float(compute="_compute_diff_in_percent")
