...
class TestProductHistory(TransactionCase):
    def setUp(self):
        ...
        self.customer_location_id = self.env.ref("stock.stock_location_customers").id
        self.supplier_location_id = self.env.ref("stock.stock_location_suppliers").id
        self.loss_location_id = self.env.ref("stock.stock_location_scrapped").id
        # Purchase moves
