...
Product Category (choose one product category; enable *Include Subcategories* to also include products from nested subcategories). When you start the adjustment (only one at a time) clicking
